...
# Copy Cyb3rhq dashboard certs to install config dir
cp /cyb3rhq-certificates/dashboard.pem ${CONFIG_DIR}/certs/dashboard.pem
cp /cyb3rhq-certificates/dashboard-key.pem ${CONFIG_DIR}/certs/dashboard-key.pem
cp /cyb3rhq-certificates/root-ca.pem ${CONFIG_DIR}/certs/root-ca.pem
