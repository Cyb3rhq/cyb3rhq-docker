...
try:
    from cyb3rhq.rbac.orm import check_database_integrity
    from cyb3rhq.security import (
        create_user,
        get_users,
        get_roles,
        set_user_role,
    ...
    logging.error("No module 'cyb3rhq' found.")
    sys.exit(1)
...
if __name__ == "__main__":
    ...
    if username not in initial_users:
        ...
        # modify an existing user ("cyb3rhq" or "cyb3rhq-wui")
    ...
    for def_user in ['cyb3rhq', 'cyb3rhq-wui']:
